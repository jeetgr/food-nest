...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Base styles - boxy design with rounded-none
        ...
        // Boxy design
        "gap-1.5 rounded-none border bg-transparent py-2 pr-2 pl-2.5 text-xs font-medium",
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            "bg-popover text-popover-foreground rounded-none border shadow-md",
            // Animations
            "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95",
            "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
            // Layout
            "relative isolate z-50 min-w-36 max-h-(--available-height) w-(--anchor-width) origin-(--transform-origin) overflow-x-hidden overflow-y-auto duration-100",
            className,
          )}
          {...props}
        >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "gap-2 rounded-none py-1.5 pr-8 pl-2 text-xs",
        "[&_svg:not([class*='size-'])]:size-4",
